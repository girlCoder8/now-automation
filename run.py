...
def analyze(text):
    ...
    failed = [(i[0], ("\033[33mWARNING\033[0m", "\033[31mFAILED\033[0m")["assert" in i[1].lower()], i[1]) for i in
              failed]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='This program allows you to run automated tests and email logs at set intervals.')
